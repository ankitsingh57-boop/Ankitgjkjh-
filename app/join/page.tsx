        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {joinLinks.map((link, index) => (
              <Card
                key={link.id}
                className="bg-gradient-to-br from-white/15 to-white/5 border border-white/30 hover:border-orange-400/60 backdrop-blur-sm shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.2}s` }}
              >
                <CardContent className="p-8">
                  <div className="text-center space-y-6">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-r from-orange-500 to-teal-500 rounded-full flex items-center justify-center animate-pulse shadow-lg">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-orange-500 to-teal-500 hover:from-orange-600 hover:to-teal-600 text-white py-4 text-lg rounded-xl transition-all duration-300 hover:scale-105 shadow-lg font-semibold"
                    >
          ...
          <div className="mt-16 text-center animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
            <Card className="bg-gradient-to-r from-orange-600/25 to-teal-600/25 border border-orange-400/40 backdrop-blur-sm shadow-2xl">
              <CardContent className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="font-bold mb-2 text-teal-400 text-lg drop-shadow-md">Exclusive Content</h4>
                    <p className="text-white/95 font-medium drop-shadow-sm">
                      Access to exclusive movies and special content
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-orange-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <h4 className="font-bold mb-2 text-orange-400 text-lg drop-shadow-md">Community Support</h4>
                    <p className="text-white/95 font-medium drop-shadow-sm">Join a community of movie enthusiasts</p>
                  </div>
                </div>
              </CardContent>
            </Card>
